      ...
      {!isPlaceOrderClicked ? (
        ...
        <div className="flex gap-2">
          ...
          {/* <button
            ...
            className="w-full flex justify-center items-center border border-indigo-500 bg-white bg-gray-100 py-2 mt-5"
          >
             Stripe
          </button> */}
         <button
  onClick={createOrderStripe}
  className="w-full flex justify-center items-center border border-[#635bff] text-[#635bff] hover:bg-[#635bff] hover:text-white font-semibold text-xl tracking-tight rounded-md py-2 mt-5 transition-colors duration-200"
>
  Stripe
</button>
        </div>
